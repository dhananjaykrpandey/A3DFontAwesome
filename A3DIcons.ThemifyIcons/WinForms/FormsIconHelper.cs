...
namespace A3DIcons.ThemifyIcons
{
    public static class FormsIconHelper
    {
        ...
        /// <param name="flip">Icon flip</param>
        /// <returns>The rendered bitmap</returns>
        public static Bitmap ToBitmap(this ThemifyIcons icon, IconFont iconFont = IconFont.Auto,
            int size = DefaultSize, Color? color = null,
            double rotation = 0.0, FlipOrientation flip = FlipOrientation.Normal)
        {
        ...
        /// <param name="flip">Icon flip</param>
        /// <returns>The rendered bitmap</returns>
        public static Bitmap ToBitmap(this ThemifyIcons icon, Color? color = null,
        ...
        /// <param name="flip">Icon flip</param>
        /// <returns>The rendered bitmap</returns>
        public static Bitmap ToBitmap(this ThemifyIcons icon,
        ...
        public static void AddIcon(this ImageList imageList, ThemifyIcons icon,
        ...
        public static void AddIcons(this ImageList imageList,
            Color? color = null, int size = IconHelper.DefaultSize, params ThemifyIcons[] icons)
        {
        ...
        internal static FontFamily FontFamilyFor(this ThemifyIcons iconChar)
        {
        ...
        internal static FontFamily FontFamilyFor(this ThemifyIcons iconChar, IconFont iconFont)
        {
