...
namespace A3DIcons.ThemifyIcons
{
    ...
    public static class IconHelper
    {
        ...
        public static readonly ThemifyIcons[] Orphans = {
            ThemifyIcons.None
        ...
        /// All valid icons.
        /// </summary>
        public static readonly ThemifyIcons[] Icons = Enum.GetValues(typeof(ThemifyIcons))
            .Cast<ThemifyIcons>().Except(Orphans).ToArray();
        ...
        /// <param name="size">The icon size in pixels</param>
        /// <returns>The rendered image</returns>
        public static ImageSource ToImageSource(this ThemifyIcons iconChar,
            Brush brush = null, double size = DefaultSize)
        {
        ...
        /// <param name="size">The icon size in pixels</param>
        /// <returns>The rendered image</returns>
        public static ImageSource ToImageSource(this ThemifyIcons iconChar, IconFont iconFont,
            Brush brush = null, double size = DefaultSize)
        {
        ...
        #region Internal
        internal static FontFamily FontFor(ThemifyIcons iconChar)
        {
            return TypefaceFor(iconChar)?.FontFamily;
        }

        internal static FontFamily FontFor(ThemifyIcons iconChar, IconFont iconFont)
        {
            return TypefaceFor(iconChar, iconFont)?.FontFamily;
        }

        internal static Typeface TypefaceFor(ThemifyIcons iconChar)
        {
            return Orphans.Contains(iconChar) ? null : Typefaces.Find(iconChar.UniCode(), out _, out _);
        }


        internal static Typeface TypefaceFor(ThemifyIcons iconChar, IconFont iconFont)
        {
...
#pragma warning restore CS0618
        ...
        {
            { (int)IconFont.Regular,  "themify"}, // fa-regular-400.ttf
            { (int)IconFont.Solid, "themify"}, // fa-solid-900.ttf
            { (int)IconFont.Brands, "themify"} // fa-brands-400.ttf
        };
