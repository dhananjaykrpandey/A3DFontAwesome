...
namespace A3DFontAwesome.LineAwesome
{
    public static class FormsIconHelper
    {
        ...
        /// <param name="flip">Icon flip</param>
        /// <returns>The rendered bitmap</returns>
        public static Bitmap ToBitmap(this LineAwesomeIcons icon, IconFont iconFont = IconFont.Auto,
            int size = DefaultSize, Color? color = null,
            double rotation = 0.0, FlipOrientation flip = FlipOrientation.Normal)
        {
        ...
        /// <param name="flip">Icon flip</param>
        /// <returns>The rendered bitmap</returns>
        public static Bitmap ToBitmap(this LineAwesomeIcons icon, Color? color = null,
        ...
        /// <param name="flip">Icon flip</param>
        /// <returns>The rendered bitmap</returns>
        public static Bitmap ToBitmap(this LineAwesomeIcons icon,
        ...
        public static void AddIcon(this ImageList imageList, LineAwesomeIcons icon,
        ...
        public static void AddIcons(this ImageList imageList,
            Color? color = null, int size = IconHelper.DefaultSize, params LineAwesomeIcons[] icons)
        {
        ...
        internal static FontFamily FontFamilyFor(this LineAwesomeIcons iconChar)
        {
        ...
        internal static FontFamily FontFamilyFor(this LineAwesomeIcons iconChar, IconFont iconFont)
        {
        ...
        {
            var fontFiles = new[] { "la-solid-900.ttf", "la-regular-400.ttf", "la-brands-400.ttf" };
            var fonts = new PrivateFontCollection();
