...
namespace A3DFontAwesome.LineAwesome
{
    ...
    /// </summary>
    public class LineToolStripButton : IconToolStripButton<LineAwesomeIcons>, IHaveIconFont
    {
        public LineToolStripButton() : base(LineAwesomeIcons.None.FontFamilyFor())
        {
        }
