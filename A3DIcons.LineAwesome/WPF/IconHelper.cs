...
namespace A3DFontAwesome.LineAwesome
{
    ...
    public static class IconHelper
    {
        ...
        public static readonly LineAwesomeIcons[] Orphans = {
            LineAwesomeIcons.None
            // not contained in any of the ttf-fonts!
            ,LineAwesomeIcons.StarO
        };

        /// <summary>
        /// All valid icons.
        /// </summary>
        public static readonly LineAwesomeIcons[] Icons = Enum.GetValues(typeof(LineAwesomeIcons))
            .Cast<LineAwesomeIcons>().Except(Orphans).ToArray();
        ...
        /// <param name="size">The icon size in pixels</param>
        /// <returns>The rendered image</returns>
        public static ImageSource ToImageSource(this LineAwesomeIcons iconChar, IconFont iconFont,
            Brush brush = null, double size = DefaultSize)
        {
        ...
        #region Internal
        internal static FontFamily FontFor(LineAwesomeIcons iconChar)
        {
            return TypefaceFor(iconChar)?.FontFamily;
        }

        internal static FontFamily FontFor(LineAwesomeIcons iconChar, IconFont iconFont)
        {
            return TypefaceFor(iconChar, iconFont)?.FontFamily;
        }

        internal static Typeface TypefaceFor(LineAwesomeIcons iconChar)
        {
            return Orphans.Contains(iconChar) ? null : Typefaces.Find(iconChar.UniCode(), out _, out _);
        }


        internal static Typeface TypefaceFor(LineAwesomeIcons iconChar, IconFont iconFont)
        {
...
#pragma warning restore CS0618
        ...
        {
            { (int)IconFont.Regular,  "la-regular-400"}, // fa-regular-400.ttf
            { (int)IconFont.Solid, "la-solid-900"}, // fa-solid-900.ttf
            { (int)IconFont.Brands, "la-brands-400"} // fa-brands-400.ttf
        };
