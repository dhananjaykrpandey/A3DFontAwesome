...
namespace NpccIconBusiness
{
    public static class FormsIconHelper
    {
        ...
        /// <param name="flip">Icon flip</param>
        /// <returns>The rendered bitmap</returns>
        public static Bitmap ToBitmap(object icon, IconFont iconFont = IconFont.Auto,
            int size = DefaultSize, Color? color = null,
            double rotation = 0.0, FlipOrientation flip = FlipOrientation.Normal)
        {
        ...
        /// <param name="flip">Icon flip</param>
        /// <returns>The rendered bitmap</returns>
        public static Bitmap ToBitmap(object icon, Color? color = null,
        ...
        /// <param name="flip">Icon flip</param>
        /// <returns>The rendered bitmap</returns>
        public static Bitmap ToBitmap(object icon,
        ...
        public static void AddIcon(this ImageList imageList, Object icon,
        ...
        public static void AddIcons(this ImageList imageList,
            Color? color = null, int size = IconHelper.DefaultSize, params Object[] icons)
        {
        ...
        internal static FontFamily FontFamilyFor(object iconChar)
        {
        ...
        internal static FontFamily FontFamilyFor(this Object iconChar, IconFont iconFont)
        {
