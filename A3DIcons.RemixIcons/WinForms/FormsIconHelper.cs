...
namespace A3DIcons.RemixIcons
{
    public static class FormsIconHelper
    {
        ...
        /// <param name="flip">Icon flip</param>
        /// <returns>The rendered bitmap</returns>
        public static Bitmap ToBitmap(this RemixIcon icon, IconFont iconFont = IconFont.Auto,
            int size = DefaultSize, Color? color = null,
            double rotation = 0.0, FlipOrientation flip = FlipOrientation.Normal)
        {
        ...
        /// <param name="flip">Icon flip</param>
        /// <returns>The rendered bitmap</returns>
        public static Bitmap ToBitmap(this RemixIcon icon, Color? color = null,
        ...
        /// <param name="flip">Icon flip</param>
        /// <returns>The rendered bitmap</returns>
        public static Bitmap ToBitmap(this RemixIcon icon,
        ...
        public static void AddIcon(this ImageList imageList, RemixIcon icon,
        ...
        public static void AddIcons(this ImageList imageList,
            Color? color = null, int size = IconHelper.DefaultSize, params RemixIcon[] icons)
        {
        ...
        internal static FontFamily FontFamilyFor(this RemixIcon iconChar)
        {
            if (Fonts.Value == null) return Throw("Icon source font files not found!");
        ...
        internal static FontFamily FontFamilyFor(this RemixIcon iconChar, IconFont iconFont)
        {
        ...
        {
            var fontFiles = new[] { "remixicon.ttf" };
            var fonts = new PrivateFontCollection();
