...
namespace A3DIcons.RemixIcons
{
    ...
    public static class IconHelper
    {
        ...
        public static readonly RemixIcon[] Orphans = {
            RemixIcon.None
        ...
        /// All valid icons.
        /// </summary>
        public static readonly RemixIcon[] Icons = Enum.GetValues(typeof(RemixIcon))
            .Cast<RemixIcon>().Except(Orphans).ToArray();
        ...
        /// <param name="size">The icon size in pixels</param>
        /// <returns>The rendered image</returns>
        public static ImageSource ToImageSource(this RemixIcon iconChar,
            Brush brush = null, double size = DefaultSize)
        {
        ...
        /// <param name="size">The icon size in pixels</param>
        /// <returns>The rendered image</returns>
        public static ImageSource ToImageSource(this RemixIcon iconChar, IconFont iconFont,
            Brush brush = null, double size = DefaultSize)
        {
        ...
        #region Internal
        internal static FontFamily FontFor(RemixIcon iconChar)
        {
            return TypefaceFor(iconChar)?.FontFamily;
        }

        internal static FontFamily FontFor(RemixIcon iconChar, IconFont iconFont)
        {
            return TypefaceFor(iconChar, iconFont)?.FontFamily;
        }

        internal static Typeface TypefaceFor(RemixIcon iconChar)
        {
            return Orphans.Contains(iconChar) ? null : Typefaces.Find(iconChar.UniCode(), out _, out _);
        }


        internal static Typeface TypefaceFor(RemixIcon iconChar, IconFont iconFont)
        {
...
#pragma warning restore CS0618
        ...
        {
            { (int)IconFont.Regular,  "remixicon"}, // fa-regular-400.ttf
            { (int)IconFont.Solid, "remixicon"}, // fa-solid-900.ttf
            { (int)IconFont.Brands, "remixicon"} // fa-brands-400.ttf
        };
