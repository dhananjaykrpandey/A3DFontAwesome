...
namespace A3DIcons.ionicons
{
    public static class FormsIconHelper
    {
        ...
        /// <param name="flip">Icon flip</param>
        /// <returns>The rendered bitmap</returns>
        public static Bitmap ToBitmap(this IonIcons icon, IconFont iconFont = IconFont.Auto,
            int size = DefaultSize, Color? color = null,
            double rotation = 0.0, FlipOrientation flip = FlipOrientation.Normal)
        {
        ...
        /// <param name="flip">Icon flip</param>
        /// <returns>The rendered bitmap</returns>
        public static Bitmap ToBitmap(this IonIcons icon, Color? color = null,
        ...
        /// <param name="flip">Icon flip</param>
        /// <returns>The rendered bitmap</returns>
        public static Bitmap ToBitmap(this IonIcons icon,
        ...
        public static void AddIcon(this ImageList imageList, IonIcons icon,
        ...
        public static void AddIcons(this ImageList imageList,
            Color? color = null, int size = IconHelper.DefaultSize, params IonIcons[] icons)
        {
        ...
        internal static FontFamily FontFamilyFor(this IonIcons iconChar)
        {
        ...
        internal static FontFamily FontFamilyFor(this IonIcons iconChar, IconFont iconFont)
        {
        ...
        {
            var fontFiles = new[] { "ionicons.ttf" };
            var fonts = new PrivateFontCollection();
