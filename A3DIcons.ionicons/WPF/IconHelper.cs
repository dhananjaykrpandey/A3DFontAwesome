...
namespace A3DIcons.ionicons
{
    ...
    public static class IconHelper
    {
        ...
        public static readonly IonIcons[] Orphans = {
            IonIcons.None
        ...
        /// All valid icons.
        /// </summary>
        public static readonly IonIcons[] Icons = Enum.GetValues(typeof(IonIcons))
            .Cast<IonIcons>().Except(Orphans).ToArray();
        ...
        /// <returns></returns>
        public static System.Windows.Media.FontFamily LoadFont(this Assembly assembly, string path, string fontTitle)
        {
        ...
        public static ImageSource ToImageSource<TEnum>(this System.Windows.Media.FontFamily fontFamily, TEnum icon,
            System.Windows.Media.Brush brush = null, double size = DefaultSize)
        ...
        /// <param name="size">The icon size in pixels</param>
        /// <returns>The rendered image</returns>
        public static ImageSource ToImageSource(this IonIcons iconChar,
            System.Windows.Media.Brush brush = null, double size = DefaultSize)
        {
        ...
        /// <param name="size">The icon size in pixels</param>
        /// <returns>The rendered image</returns>
        public static ImageSource ToImageSource(this IonIcons iconChar, IconFont iconFont,
            System.Windows.Media.Brush brush = null, double size = DefaultSize)
        {
        ...
        #region Internal
        internal static System.Windows.Media.FontFamily? FontFor(IonIcons iconChar)
        {
            return TypefaceFor(iconChar)?.FontFamily;
        }

        internal static System.Windows.Media.FontFamily? FontFor(IonIcons iconChar, IconFont iconFont)
        {
            return TypefaceFor(iconChar, iconFont)?.FontFamily;
        }

        internal static Typeface? TypefaceFor(IonIcons iconChar)
        {
            return Orphans.Contains(iconChar) ? null : Typefaces.Find(iconChar.UniCode(), out _, out _);
        }


        internal static Typeface TypefaceFor(IonIcons iconChar, IconFont iconFont)
        {
        ...
        #region Private
        private static ImageSource ToImageSource(System.Windows.Media.Brush foregroundBrush, double size, GlyphTypeface gt, ushort glyphIndex)
        {
...
#pragma warning disable CS0618 // Deprecated constructor
            var glyphRun = new GlyphRun(gt, 0, false, fontSize,
                new[] { glyphIndex }, new System.Windows.Point(0, 0), new[] { width },
...
#pragma warning restore CS0618
        ...
        {
            { (int)IconFont.Regular,  "Ionicons"}, // fa-regular-400.ttf
            { (int)IconFont.Solid, "Ionicons"}, // fa-solid-900.ttf
            { (int)IconFont.Brands, "Ionicons"} // fa-brands-400.ttf
        };
